...
project = "atomic_femdvr"
copyright = f"{date.today().year}, Michael Schüler"
author = "Michael Schüler"
...
modindex_common_prefix = ["atomic_femdvr."]
...
htmlhelp_basename = "atomic_femdvr_doc"
